...
A summary of the approach taken and key results of the analysis are described for each use case in the individual sections of this report. Full details of the approach are also detailed in:

-   Apendices - Step by step approach, with data tables and plots
-   Jupyter Notebooks - Full listings of Python code and results in [GitHub Repository](https://github.com/StuartG24/Travel_Co_Analysis "GitHub")
-   Data Files - Generated CSV files in [GitHub Repository](https://github.com/StuartG24/Travel_Co_Analysis "GitHub")
